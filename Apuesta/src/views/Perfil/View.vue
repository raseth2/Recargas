        ...
        <a-row type="flex" align="middle">
          <a-col :span="24" :md="12" class="col-info">
            ...
            <div class="avatar-info">
              <h4 class="font-semibold m-0">{{name_client}} {{last_name}}</h4>     
              <p>{{player_id}}</p>    
            </div>
          </a-col>
          <a-col
            ...
            "
          >
            <a-card :bordered="false" class="widget-1" style="width: 40%">
              <a-statistic
                title="Billetera"
                :value="wallet.total"
                class="text-success"
...
export default {
  ...
  methods: {
    info(){
      this.name_client=localStorage.getItem('name_user');      
    ...
    tables() {
      let me = this;
      let id = 1;
      let url = me.url_base2 + "table/" + id;
      axios({
        method: "GET",
        url: url,
      })
        .then(function (response) {
          me.hisotorywallet = response.data.hisotorywallet;
